...
public class InputAppState extends AbstractAppState implements AnalogListener, ActionListener {
    ...
    private String[] mappingNames = new String[]{InputMapping.LeanFree.name(), InputMapping.LeanLeft.name(), InputMapping.LeanRight.name(), InputMapping.RotateLeft.name(), InputMapping.RotateRight.name(), InputMapping.LookUp.name(), InputMapping.LookDown.name(), InputMapping.StrafeLeft.name(), InputMapping.StrafeRight.name(), InputMapping.MoveForward.name(), InputMapping.MoveBackward.name(), InputMapping.ToggleControl.name()};
    ...
    private void addInputMappings(){
        ...
        inputManager.addMapping(InputMapping.ToggleControl.name(), new KeyTrigger(KeyInput.KEY_C), new KeyTrigger(KeyInput.KEY_DOWN));
